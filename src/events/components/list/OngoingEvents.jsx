...
const OngoingEvents = () => {
  const { data: ongoingEvents, run, status, error, setData } = useAsync();
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      run(eventsService.fetchOngoingEvents()).catch((error) =>
        console.error(error)
      );
    };
    fetchEvents();
